...
This article has been written by Gabor Gergely (kodfodrasz) as a guest post on this blog. He is the lead engineer of our engineering organization working on F#, AWS and Elm.
...
![Where to select that run configuration](/img/advent_article_part1-run_config.jpg)

Now you should see something like this:

![It runs!](/img/advent_article_part1-it_runs.jpg)
...
![Image of locally running service responding to queries as expected](/img/advent_article_part1_additional_routes.jpg)
...
Second, a `global.json` file needs to be added and set up to prevent [automatic version _roll forward_](https://docs.microsoft.com/en-us/dotnet/core/tools/global-json?tabs=netcore3x#rollforward). Add the `global.json` file to the root of the projects (the solution directory).
...
This file references a _template_, `serverless.template`. That will be the second config file we will need to create.
...
![Falco responding successfully from AWS Lambda](/img/advent_article_part2-hello_serverless.jpg)
